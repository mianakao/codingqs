# RailsAdmin config file. Generated on October 29, 2012 11:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Coding Qs', 'Admin']
  ...
  # config.excluded_models = ['Category', 'Language', 'Question', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Language', 'Question', 'User']
  ...
  #     configure :id, :integer 
  #     configure :qtext, :text 
  #     configure :difficulty, :integer 
  #     configure :votes, :integer 
