...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<nested_form>, ["~> 0.2.3"])
      s.add_runtime_dependency(%q<sass-rails>, ["~> 3.1"])
      s.add_runtime_dependency(%q<bootstrap-sass>, ["~> 2.0"])
      s.add_runtime_dependency(%q<font-awesome-sass-rails>, ["~> 2.0"])
      s.add_runtime_dependency(%q<jquery-ui-rails>, ["~> 2.0"])
      ...
      s.add_dependency(%q<nested_form>, ["~> 0.2.3"])
      s.add_dependency(%q<sass-rails>, ["~> 3.1"])
      s.add_dependency(%q<bootstrap-sass>, ["~> 2.0"])
      s.add_dependency(%q<font-awesome-sass-rails>, ["~> 2.0"])
      s.add_dependency(%q<jquery-ui-rails>, ["~> 2.0"])
